...
class Uploader {
    ...
    _uploadS3(stream) {
        ...
        const filename = this.options.metadata.filename || this.options.metadata.name || path.basename(this.path);
        ...
        const upload = client.upload({
            ...
            ContentType: this.options.metadata.type,
            Body: stream,
            ContentDisposition: options.params.getContentDisposition(filename),
            ServerSideEncryption: options.params.ServerSideEncryption
        });
